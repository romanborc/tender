...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Tender</a>
      ...
      <div class="row">
              ...
              <li class="nav-item">
                  <a data-toggle="dropdown" class="nav-link" href="#">
                      <span class="clear"> <span> <strong class="font-bold">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</strong>
                       </span> <span class="text-muted block"> Manager</span> </span> </a>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Панель Управления Менеджера</h1>
          </div>

          
          <div class="row head">
          	<div class="col-md-9"><h2>Все закупки</h2></div>
          	<div class="col-md-3">
          		<a href="#" class="btn btn-info btn-rounded">Фильтры</a>
          		<a href="#" class="btn btn-primary btn-rounded">+ Добавить Закупку</a>
          	</div>
          </div>
